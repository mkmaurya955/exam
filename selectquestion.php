...
<div class="row">
	<div class="col-sm-3">
		<INPUT TYPE="button" class="btn btn-primary" VALUE="Add new one word question" ONCLICK="location.href='add1word.php'"/>
	</div>
	<div class="col-sm-3">
		<INPUT TYPE="button" class="btn btn-primary" VALUE="Add new brief question" ONCLICK="location.href='addbrief.php'"/>
	</div>
	<div class="col-sm-3">
		<INPUT TYPE="button" class="btn btn-primary" VALUE="Add new MCQ question" ONCLICK="location.href='addmcq.php'"/>
	</div>
	<div class="col-sm-3">
